...
const GENERATED = [
	...
	// This tool's own bookkeeping. Every stamping run rewrites the review store
	// and a ratchet rewrites the budget, so counting them as dependencies makes
	// the doc that explains stamping go stale every time anyone stamps anything:
	// a permanent false positive generated by using the system correctly.
	/^data\/docs-freshness-(reviews|budget)\.json$/,
